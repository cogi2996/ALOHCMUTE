...
@WebServlet(urlPatterns = { "/admin-manage/user/listuser", "/admin-manage/user/delete", "/admin-manage/user/update",
		"/admin-manage/user/following", "/admin-manage/user/follower", "/admin-manage/user/profile",
		"/admin-manage/user/posts", "/admin-manage/user/searchUser" })
