import { app, db, auth, onAuthStateChanged } from "/SOCIALMEDIA/templates/firebase/firebase.js";
...
const loadChildComment = function(parentComment) {
	...
	parentComment.querySelector(".btn__show-more .small").textContent = `${sizeOfChildComment != 0 ? ` ${sizeOfChildComment} ` : ""
		} Trả lời`;
};
