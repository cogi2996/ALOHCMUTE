	...
	<div class="container mt-5">
		<form action='<c:url value="/dangki"></c:url>' method="post">
			<div class="form-group">
				<label for="gmail">Gmail:</label> <input type="email"
					class="form-control col-md-4" id="gmail" name="gmail" required>
			</div>
			<div class="form-group ">
				<label for="password">Mật khẩu:</label> <input type="password"
					class="form-control col-md-4" id="password" name="password"
					required>
			</div>
			<div class="form-group ">
				<label for="mobile">Số điện thoại:</label> <input type="tel"
					class="form-control col-md-4" id="mobile" name="mobile" required>
			</div>
			<div class="form-row">
				...
				<div class="form-group col-md-4">
					<label for="midName">Tên đệm:</label> <input type="text"
			...
			<div class="form-group">
				<label for="workPlace">Khoa:</label> <input type="text"
					class="form-control col-md-4" id="workPlace" name="workPlace"
					required>
			</div>
			<div class="form-group">
				<label for="position">Ngành học:</label> <input type="text"
					class="form-control col-md-4" id="position" name="position"
					required>
			</div>
